...
public class Main {
    ...
    public static void main (String [] args){
        ...
        // A loop is initiated until user inputs 5
        ...
        while (choice != 5) {
            ...
            if (choice == 1) {
                ...
                System.out.println("In this hall is a buffet table with all sorts of mouth watering delicacies");
            ...
            // CHOICE 4
                ...
                if (choice == 'a') {
                    ...
                    System.out.println("It has become a river of volcanic larva and you fall right in");
            ...
            // CHOICE 5
                ...
                System.out.println("Goodbye" + name +"!!!" + " " + " You shall NOT be missed");
            }
            }
        }
    }
